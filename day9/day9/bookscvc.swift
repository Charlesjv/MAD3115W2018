...
class bookscvc: UICollectionViewController {
    let booktitles = ["The Alchemist","The storty of an hour","Breaking Dawn","A jury of her peers","The Last Leaf","The day I Stopped Drinking Milk", "O monte Cinco","RedQueen","The sky is falling","The necklace","The wise and otherwise"]
